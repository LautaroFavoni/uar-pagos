...
const TIPO_COLORS: Record<string, string> = {
  principal: "border-l-brand bg-blue-50/50 hover:bg-blue-100 text-brand shadow-blue-100/50",
      ...
      {ligas.map((liga) => (
        <Card
          ...
          className={cn(
            ...
            selectedId === liga.id ? "ring-2 ring-brand ring-offset-2 scale-[1.02] z-10 opacity-100 grayscale-0 shadow-lg" : "opacity-80 grayscale-[20%] hover:grayscale-0"
          )}
